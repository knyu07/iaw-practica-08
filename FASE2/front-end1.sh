...
sed -i /DB_COLLATE/a define('WP_SITEURL'), 'http://$IP_PUBLICA_BALANCEADOR/wordpress');" /var/www/html/wordpress/wp_config.php
sed -i /WP_SITEURL/a define('WP_HOME'), 'http://$IP_PUBLICA_BALANCEADOR');" /var/www/html/wordpress/wp_config.php
